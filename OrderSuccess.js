var confetti = {
	maxCount: 70,		//set max confetti count
...
(function() {
	...
	function startConfetti(timeout, min, max) {
		...
		if (canvas === null) {
			...
			canvas.setAttribute("style", "display:block;z-index:999999;pointer-events:none;position:fixed;top:20%");
	...
	function updateParticles() {
		...
		for (var i = 0; i < particles.length; i++) {
			...
			if (particle.x > width + 20 || particle.x < -15 || particle.y > height) {
